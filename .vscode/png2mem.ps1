param(
    ...
    # Rows trimmed off the TOP of the source before any stretch/fit. Used on the
    # background to control how much sky vs ground the map shows: daylight.png is
    # 2048x768 with grass starting at row 565, so cropping the first 260 rows
    # leaves 508 rows with the grass line at 60% -> 60% sky / 40% ground on screen.
